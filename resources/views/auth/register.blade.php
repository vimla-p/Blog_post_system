    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('registeruser') }}" method="post" id="UserForm">
                    @csrf
                    ...
                    <div class="input-group mb-3">
                        <input type="tel" class="form-control  @error('contact') is-invalid @enderror"
                            name="contact" placeholder="contact" value="{{ old('contact') }}" required
                ...
                <a href="{{ route('login') }}" class="text-center">I already have a registered</a>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
